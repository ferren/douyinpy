...
from douyinpy.utils import DouyinSigner, random_string
from douyinpy.client.api.base import BaseDouyinAPI
from douyinpy.schemes import JsApiCardExt


class DouyinJSAPI(BaseDouyinAPI):
    ...
    def get_jsapi_signature(self, noncestr, ticket, timestamp, url):
        ...
        signer = DouyinSigner(delimiter=b"&")
    ...
    def get_jsapi_add_card_params(
        ...
        参数意义见微信文档地址：
            ...
            https://developers.weixin.qq.com/doc/offiaccount/Cards_and_Offer/Douyin_Coupon_Interface.html#4
