...
"""
    ...
    This module contains all the events Douyin callback uses.
...
from douyinpy.messages import BaseMessage
...
class PicDouyinEvent(BasePictureEvent):
    """
    弹出微信相册发图器的事件
...
class QualificationVerifySuccessEvent(BaseEvent):
    ...
    详情请参阅
    https://developers.weixin.qq.com/doc/offiaccount/Account_Management/Douyin_Accreditation_Event_Push.html
    """
