...
"""
    ...
    This module provides OAuth2 library for Douyin
...
from douyinpy.exceptions import DouyinOAuthException
...
class DouyinOAuth:
    ...
    def _request(self, method, url_or_endpoint, **kwargs):
        ...
        if "errcode" in result and result["errcode"] != 0:
            ...
            raise DouyinOAuthException(errcode, errmsg, client=self, request=res.request, response=res)
