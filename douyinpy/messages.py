...
"""
    ...
    This module defines all the messages you can get from Douyin server
...
from douyinpy.fields import BaseField, DateTimeField, FieldDescriptor, IntegerField, StringField
