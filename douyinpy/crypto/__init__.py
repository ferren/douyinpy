...
from douyinpy.utils import to_text, to_binary, WeChatSigner
from douyinpy.exceptions import (
    InvalidAppIdException,
    InvalidMchIdException,
    InvalidSignatureException,
)
from douyinpy.crypto.base import BasePrpCrypto, WeChatCipher, BaseRefundCrypto
from douyinpy.crypto.pkcs7 import PKCS7Encoder
...
class BaseWeChatCrypto:
    ...
    def _encrypt_message(self, msg, nonce, timestamp=None, crypto_class=None):
        from douyinpy.replies import BaseReply
