...
"""
    douyinpy.replies
    ~~~~~~~~~~~~~~~~~~
    This module defines all kinds of replies you can send to Douyin
...
from douyinpy.messages import BaseMessage, MessageMetaClass
...
def deserialize_reply(xml, update_time=False):
    ...
    :rtype: douyinpy.replies.BaseReply
    """
    if not xml:
        return EmptyReply()
